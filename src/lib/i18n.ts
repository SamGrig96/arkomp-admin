...
const hy = {
  ...
  editor: {
    ...
    bilingualTitle: "Կայք հասնելու համար պետք է երկու լեզուն",
    bilingualLead:
      "Հրապարակված ապրանքը պետք է նույնը կարդացվի հայերեն և ռուսերեն։ " +
      "Այլապես լեզուն փոխող այցելուն ընկնում է կիսատ էջի վրա։",
    bilingualUnpublish:
      "Կիսատ պահելու համար հանիր «Հրապարակված է կայքում» նշումը — " +
      "չհրապարակվածը կայք չի հասնում։",
    fieldNames: {
      title: "վերնագիր",
      short: "կարճ նկարագրություն",
      benefit: "քարտի ներքևի տողը",
      lead: "ներածական",
      overview: "ամփոփում",
      features: "առավելություններ",
      specs: "բնութագրեր",
...
const ru: typeof hy = {
  ...
  editor: {
    ...
    bilingualTitle: "Для сайта нужны оба языка",
    bilingualLead:
      "Опубликованная группа должна одинаково читаться по-армянски и " +
      "по-русски. Иначе посетитель, переключивший язык, попадёт на неполную страницу.",
    bilingualUnpublish:
      "Чтобы сохранить незаконченное, снимите галочку «Опубликовано на сайте» — " +
      "неопубликованное на сайт не попадает.",
    fieldNames: {
      title: "название",
      short: "краткое описание",
      benefit: "нижняя строка карточки",
      lead: "вступление",
      overview: "обзор",
      features: "преимущества",
